...
# load array
X_train_whole = loadtxt('d:\\reproduce.csv', delimiter=',')
...
# Create the model
model=Sequential()
model.add(Conv1D(filters=15, kernel_size=12, padding='valid', activation='relu', strides=3, input_shape=(153, 4)))
model.add(Conv1D(filters=15, kernel_size=12, padding='valid', activation='relu', strides=3))
model.add(AveragePooling1D(pool_size=2))
model.add(Dropout(0.2))
model.add(Conv1D(filters=15, kernel_size=4, padding='valid', activation='relu', strides=2))
...
model.save("D:\\model_conv1d_reproduce.h5")
